...
const ContactPage = () => {
    ...
    <div className="bg-transparent py-16 sm:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
         ...
         <div className="mt-24 max-w-4xl mx-auto bg-white/40 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-white/50 text-gray-800 text-lg space-y-6">
  <h3 className="text-3xl font-bold text-center text-gray-900">Cancellation & Refund Policy</h3>
  <p className="text-center text-sm text-gray-600">Last updated on 30-07-2025 13:44:22</p>
  <p>
    <strong>SHANMUGAM DEVI</strong> believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
  </p>
  ...
  <ul className="list-disc list-inside space-y-4">
    ...
    <li>
      <strong>SHANMUGAM DEVI</strong> does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
    </li>
    <li>
    ...
    <li>
      In case of any refunds approved by <strong>SHANMUGAM DEVI</strong>, it’ll take 3-5 days for the refund to be processed to the end customer.
    </li>
  </ul>
</div>
      </div>
